            ...
            <main className="flex-1 p-8 bg-gray-50/30 overflow-y-auto">
                ...
                <section className="grid grid-cols-4 gap-6 mb-12">
                    {[
                        ...
                        { label: 'Oxygen Sat', value: '98', unit: '%', status: 'normal' },
                        { label: 'Glucose', value: '112', unit: 'mg/dL', status: 'warning' }
                    ].map((vital, i) => (
                ...
                <section className="bg-white border border-gray-200 rounded-3xl overflow-hidden shadow-sm">
                    <div className="p-6 border-b border-gray-100 flex items-center justify-between">
                        <h3 className="text-xl font-black text-gray-900 tracking-tighter">Current Conditions</h3>
                        <span className="text-[10px] font-black text-gray-400 uppercase">V3.1 ENGINE ACTIVE</span>
                    </div>
                    <table className="w-full text-left">
                        <thead className="bg-gray-50 flex-none sticky top-0">
                            <tr className="border-b border-gray-100">
                                <th className="p-4 px-8 text-[11px] font-black text-gray-400 uppercase tracking-widest">ICD-10 Code</th>
